...
Note: this is a direct copy of the contents of the pull request
<https://github.com/leanprover/lean4/pull/7061>.
This copy is intended for lower Lean versions that are not yet ready for
updating to the nightly containing this pull request.
-/
...
@[command_elab setPremiseSelectorCmd, inherit_doc setPremiseSelectorCmd]
...
@[tactic suggestPremises] def evalSuggestPremises : Tactic := fun _ =>
